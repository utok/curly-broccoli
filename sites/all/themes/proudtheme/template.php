...
require_once dirname(__FILE__) . '/includes/images.inc';
 ...
 *
 */
//function proudtheme_preprocess_html(&$variables) {
 ...
 */
function proudtheme_preprocess_page(&$vars) {
 ...
 */
function proudtheme_css_alter(&$css) {
 ...
 */
function proudtheme_js_alter(&$js) {
